...
// const fetchAssignedHubZone = async () => {
//   try {
//     const response = await partnerApi.assignedZone();

//     console.log(
//       "🗺️ ASSIGNED ZONE RESPONSE:",
//       JSON.stringify(response, null, 2)
//     );

//     // Backend returns:
//     // { success: true, data: { hub_name, location, sub_locations } }

//     const zoneData =
//       (response as any)?.data?.hub_name
...
//     for (const sub of zoneData.sub_locations || []) {
...
//       try {
//         const searchAddress =
//           `${locationName}, ${pincode}, Telangana, India`;

//         const geocoded =
//           await Location.geocodeAsync(searchAddress);
...
//       } catch (geoError) {
//         console.log(
//           `❌ Geocoding failed for ${locationName} (${pincode}):`,
//           geoError
//         );
//       }
...
//     console.log("✅ ASSIGNED HUB:", hubName);
//     console.log(
//       "📍 ASSIGNED LOCATIONS:",
//       zoneData.location
//     );
...
//   } catch (error) {
//     console.error(
//       "❌ Error fetching assigned hub zone:",
//       error
//     );
//   }
// };
...
//   if (hubSubLocations.length === 0) return;
...
//   currentCoords &&
//   hubSubLocations.length > 0 &&
//   hubSubLocations[0].latitude &&
//   hubSubLocations[0].longitude && (
//     <Polyline
//       coordinates={[
//         {
//           latitude: currentCoords.latitude,
...
//         },
//         {
//           latitude: hubSubLocations[0].latitude!,
//           longitude: hubSubLocations[0].longitude!,
//         },
//       ]}
//       strokeColor="#0284c7"
//       strokeWidth={4}
...
// ============================================================
// PINCODE GEOCODING HELPERS
// ============================================================
const PINCODE_GEOCODE_CACHE: Record<string, { latitude: number; longitude: number }> = {};
